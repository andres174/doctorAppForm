        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item active">
                <a data-bs-target="#dashboards" data-bs-toggle="collapse" class="sidebar-link">
                    <i class="align-middle me-2 fas fa-fw fa-user"></i> <span class="align-middle">Ingresar</span>
                </a>
                <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                    <li class="sidebar-item active"><a class="sidebar-link" href="{{url('tipo-usuario')}}">Tipo de Usuario</a></li>
                    <li class="sidebar-item active"><a class="sidebar-link" href="{{url('especialidad')}}">Especialidad</a></li>
                    <li class="sidebar-item active"><a class="sidebar-link" href="{{url('datos-persona')}}">Datos Personales</a></li>
